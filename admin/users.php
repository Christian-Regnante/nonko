...
?>
            <tr>
                ...
                <td style="padding: 10px;"><button><a href="operations?deleteid=<?php echo $row['id'];?>">Delete</a></button></td>
                <td style="padding: 10px;"><button><a href="operations?updateid=<?php echo $row['id'];?>">Update</a></button></td>
            </tr>
<?php
    }
}
