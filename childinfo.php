...
<body>
    ...
    <div class="btn">
        <button><a href="add_family/add_childs.php">Add your children</a></button>
    </div>
    <div class="main">
        <table border="1">
            <thead>
                ...
                <th style="padding: 10px;">Mother ID</th>
            </thead>
<?php
...
?>
            <tr>
                ...
                <td style="padding: 10px;"><?php echo $row['ch_firstname'];?></td>
